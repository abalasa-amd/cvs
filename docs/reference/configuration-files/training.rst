...
|----------------------------------------------------|---------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| ``device_list``                                    | Values: - ``"/dev/dri"`` - ``"/dev/kfd"`` - ``"/dev/infiniband/rdma_cm"`` | Kernel devices exposed into the container                                                                                    |
...
| ``/lib/libibverbs.d``                              | ``/lib/libibverbs.d``                                                     | Mounts the RDMA verbs configuration directory — needed by libibverbs to detect RDMA devices                                  |
...
| ``JAX_COORDINATOR_IP``                             | ``10.2.96.21``                                                            | The IP address of the coordinator node in the cluster — all other nodes connect here to initialize                           |
| ``JAX_COORDINATOR_PORT``                           | 12345                                                                     | The port used by JAX for coordination                                                                                        |
| ``NNODES``                                         | 2                                                                         | Total number of nodes in the distributed job                                                                                 |
| ``JAX_DISTRIBUTED_INITIALIZATION_TIMEOUT_SECONDS`` | 1800                                                                      | How long JAX waits for all nodes to join the distributed setup — longer is safer for large clusters                          |
