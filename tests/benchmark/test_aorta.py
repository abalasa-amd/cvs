...
class TestAortaBenchmark:
    ...
    def test_parse_results(self, aorta_runner_config, validated_aorta_config):
        ...
        has_tracelens_analysis = (
            run_result.get_artifact("tracelens_analysis") is not None
            or (run_result.get_artifact("torch_traces") and 
                (run_result.get_artifact("torch_traces").parent / "tracelens_analysis").exists())
        )
